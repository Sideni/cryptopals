...
class PKCS_Oracle_Attacker():
    ...
    def step2a(self, c0):
        ...
        s1 = ceiled_div(self.n, (3 * self.B))
        while not self.is_valid_pkcs(c0, s1):
            s1 += 1
...
if __name__ == '__main__':
    ...
    rsa = PKCS1_5_OracleRSA(e=65537, prime_size=128)
    ...
    # This might take a while as multiple intervals are not supported yet (step 2b being not implemented)
    # It even needs to re-run many times until a "valid" key pair is generated
    m = attacker.attack(c)
